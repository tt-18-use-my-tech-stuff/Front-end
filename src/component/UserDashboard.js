...
function UserDashboard() {
  ...
  const fetchUserRequest = () => {
    return axiosWithAuth().get("/account/requests");
  };
  const fetchItemsRequest = () => {
    return axiosWithAuth().get("/account/requests/owned");
  };
    ...
    <div>
      <Navbar bg="light" variant="light">
        ...
        <Nav className="mr-auto">
          ...
          <Nav.Link href="#" onClick={() => setToggle(false)}>
            Requested
          </Nav.Link>
          <Nav.Link href="#" onClick={() => setToggle(true)}>
            My Request
          </Nav.Link>
        </Nav>
        {/* <Form inline>
